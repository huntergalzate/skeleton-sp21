...
public class LinkedListDequeTest {
    ...
    public void isEqualsTest() {
        ...
        LinkedListDeque<Integer> b = aLLDeque;
        aLLDeque.addFirst(1);
        aLLDeque.addFirst(2);
        aLLDeque.addFirst(3);
        ...
        assertEquals(aLLDeque, copyALLDeque);
        assertEquals(aLLDeque, b);

        assertEquals("should be false, comparing LLDeque to a single int", false, aLLDeque.equals("Hello"));
    }
